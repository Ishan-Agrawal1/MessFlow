  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2 bg-gradient-to-r from-blue-50 to-sky-50 rounded-xl px-4 py-2">
          <Receipt className="h-5 w-5 text-blue-600" />
          <span className="text-sm font-semibold text-blue-700">{total} Transactions</span>
        </div>
      </div>
